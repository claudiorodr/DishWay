...
*/
 ...
 (function ($) {
     /*openingTimes.jquery.js - v1.0.2 *  jQuery plugin to show when your business or organisation is open.*  http://webfactor.co * *  Made by Charles Harvey *  Under MIT License*/
     ! function (t, s, e, i) {
         "use strict";

         function n(s, e) {
             this.element = s, this.settings = t.extend({}, a, e), this._defaults = a, this._name = o, this.init()
         }
         var o = "openingTimes",
             a = {
                 openString: "",
         ...
         t.extend(n.prototype, {
             init: function () {
                 this.weekdays = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], this.date = new Date, this.current_day = this.weekdays[this.date.getDay()], this.current_hour = this.date.getHours(), this.current_minute = this.date.getMinutes(), this.place_is_open = !1, this.hoursForToday = this.settings.openingTimes[this.current_day], "object" == typeof this.hoursForToday ? 2 == this.hoursForToday.length && (this.open_unix_time_today = this.timeStringToDate(this.hoursForToday[0]), this.close_unix_time_today = this.timeStringToDate(this.hoursForToday[1]), this.date <= this.close_unix_time_today && this.date >= this.open_unix_time_today && (this.place_is_open = !0)) : !0 === this.hoursForToday && (this.place_is_open = !0), this.place_is_open ? t(this.element).append(this.settings.openString).addClass(this.settings.openClass) : t(this.element).append(this.settings.closedString).addClass(this.settings.closedClass)
             },
             timeStringToDate: function (t) {
                 var s = new Date,
                     e = t.split(":")[0],
                     i = t.split(":")[1];
                 return s.setHours(e, i, 0, 0)
             }
         }), t.fn[o] = function (s) {
             return this.each(function () {
                 t.data(this, "plugin_" + o) || t.data(this, "plugin_" + o, new n(this, s))
             })
         }
 ...
 (function ($) {
     ...
     ! function (t, i) {
         ...
         return i.defaults = {
             ...
             this.$overlay.fadeIn(this.options.fadeDuration), t(".lb-loader").fadeIn("slow"), this.$lightbox.find(".lb-image, .lb-nav, .lb-prev, .lb-next, .lb-numbers").hide(), this.$outerContainer.addClass("animating");
             var a = new Image;
             a.onload = function () {
                 var o, s, h, r, l, d;
                 n.attr({
             ...
             this.$lightbox.find(".lb-loader").stop(!0).hide(), this.$lightbox.find(".lb-image").delay(250).fadeIn(150), this.updateNav(), this.updateDetails(), this.preloadNeighboringImages(), this.enableKeyboardNav()
             ...
             if (void 0 !== this.album[this.currentImageIndex].title && "" !== this.album[this.currentImageIndex].title) {
                 ...
                 this.options.sanitizeTitle ? i.text(this.album[this.currentImageIndex].title) : i.html(this.album[this.currentImageIndex].title), i.fadeIn("fast").find("a").on("click", function (i) {
             ...
             this.disableKeyboardNav(), t(window).off("resize", this.sizeOverlay), this.$lightbox.fadeOut(this.options.fadeDuration), this.$overlay.delay(250).fadeOut(this.options.fadeDuration), t("select, object, embed").css({
                 visibility: "visible"
